...
def getMinibatch(file_names):
    ...
    for i, file_name in enumerate(file_names):
        # 构建图片文件路径
        img_file_path = os.path.join("/home/featurize/lsy/dataset/train-png", os.path.basename(file_name).replace('.mat', '.png'))
...
torch.save(unet_model.state_dict(), '/home/featurize/lsy/WPCP/weights/7-27-png.pkl')  # 保存 U-Net 模型的参数
